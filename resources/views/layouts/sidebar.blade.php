<div x-data="{ open: true }" class="h-screen sticky top-0 w-1/5 bg-white overflow-y-auto p-4">
    <div class="flex mb-4">
        ...
        <h1 class="ml-2 text-green-400 font-bold text-2xl hidden sm:block">Kykapu SMS</h1>
    </div>
...
<div class="text-gray-400 text-left text-base leading-tight px-2 py-2">
        ...
        <a href="{{url('client/add')}}">
            <x-item type="mainItem">
                ...
                <span class="px-2 py-1">Clients</span>
            </x-item>
        </a>
        ...
        <a href="">
            <x-item type="mainItem">
                ...
                <span class="px-2 py-1">Settings</span>
            </x-item>
        </a>
